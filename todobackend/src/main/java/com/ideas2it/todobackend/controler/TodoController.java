...
public class TodoController {
	...
	public List<TodoDto> getByUser(@RequestParam("userId") Integer userId) {
	...
	public List<TodoDto> searchTask(@RequestParam("taskName") String todo) {
		return todoService.searchTask(todo);
	}
}
